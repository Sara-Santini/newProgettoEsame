...
public class AppController {
	 ...
	 * 
	 * @param image Image of Instagram.
	 * @see DataBase
	 ...
	 * @throws ParseException          which is thrown if there is any problem in
	...
	public ResponseEntity<Object> getSomeFilters2(@RequestBody String json)
			throws ParseException, NumberFormatException, FilterNotFoundException, EmptyCollectionException {
