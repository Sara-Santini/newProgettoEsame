...
class JTest {
	...
	void setUp() throws Exception {
		data = new DataBase();
		Photos foto = new Photos("17963418202137327",
				"https://scontent.cdninstagram.com/v/t51.2885-15/43914773_544273275994752_2221340766346393107_n.jpg?_nc_cat=108&_nc_sid=8ae9d6&_nc_ohc=a2O2SaubpHkAX_yKNy-&_nc_ht=scontent.cdninstagram.com&oh=90bb3428e81db69913056c8aabcc69c5&oe=5EF81E4A");
		...
		Photos photo1 = new Photos("17872742938318962",
				"https://scontent.cdninstagram.com/v/t51.2885-15/52929473_530102834182818_7229678577976313998_n.jpg?_nc_cat=110&_nc_sid=8ae9d6&_nc_ohc=luOEmk44cEgAX8TJho7&_nc_ht=scontent.cdninstagram.com&oh=ca675ba9ff17cefa6bf0f8521946594e&oe=5EFB89C0");
		Photos photos2 = new Photos("17851463515365484",
				"https://scontent.cdninstagram.com/v/t51.2885-15/53123426_336001267020626_3492049144165672302_n.jpg?_nc_cat=104&_nc_sid=8ae9d6&_nc_ohc=5mBtYREdAIAAX-AD-Se&_nc_ht=scontent.cdninstagram.com&oh=1dd225528ebf553b2014c225bf439665&oe=5EFA2E31");
		...
		photos.add(photos2);
		album = new Album("18038680510033530",
	...
	@Test
	void test5() {
		assertAll("valori", () -> assertEquals("18038680510033530", album.getId()), () -> assertEquals(
				"Il più grande spreco nel mondo è la differenza tra ciò che siamo e ciò che potremmo diventare.\\n#ancona",
				album.getCaption()), () -> assertEquals("ALBUM", album.getMedia_type()),
	...
	void test8() {
		assertThrows(FilterNotFoundException.class,
				() -> data.filterservice("{ \"filter\": [ { \"field\": \"To%\", \"param\": \"5\" }]}"));
	}

	@Test
	void test9() {
		assertThrows(EmptyCollectionException.class,
				() -> data.filterservice("{ \"filter\": [ { \"field\": \"Un!\", \"param\": \"1\" }]}").getApi());
	}
}
